...
import com.tecsup.app.micro.payment.domain.exception.UserServiceUnavailableException;
import com.tecsup.app.micro.payment.domain.model.User;
import com.tecsup.app.micro.payment.infrastructure.client.dto.UserDto;
import com.tecsup.app.micro.payment.infrastructure.client.mapper.UserDtoMapper;
...
//            return userDTOMapper.toDomain(user);
    ...
    public User getUserFallback(Long userId, String jwtToken, Throwable throwable) {
        ...
        log.error("User Service unavailable. Error: {}",
